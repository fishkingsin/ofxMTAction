...
void testApp::tuioObjectAdded(ofxTuioObject & tobj){
/*	cout << " object added: " + ofToString(tobj.getSymbolID())+
	...
	ofxMarker.markerDown(tobj.getFiducialId(), tobj.getX(), tobj.getY(), tobj.getAngleDegrees());
}

void testApp::tuioObjectRemoved(ofxTuioObject & tobj){
/*	cout << " object removed: " + ofToString(tobj.getSymbolID())+
	...
	//forward the marker events to ofxMarker for the InteractiveObjects
	ofxMarker.markerUp(tobj.getFiducialId(), tobj.getX(), tobj.getY(), tobj.getAngleDegrees());
}

void testApp::tuioObjectUpdated(ofxTuioObject & tobj){
	...
	//forward the marker events to ofxMarker for the InteractiveObjects
	ofxMarker.markerMoved(tobj.getFiducialId(), tobj.getX(), tobj.getY(), tobj.getAngleDegrees());
}

void testApp::tuioCursorAdded(ofxTuioCursor & tcur){
	...
	mtActionsHub.touchDown(tcur.getX(), tcur.getY(), tcur.getFingerId(), &multiTouchCustomData);
	mtSliderHub.touchDown(tcur.getX(), tcur.getY(), tcur.getFingerId(), &multiTouchCustomData);
	...
	*/
	...
	ofxMultiTouch.touchDown(tcur.getX(), tcur.getY(), tcur.getFingerId(), &multiTouchCustomData);
}

void testApp::tuioCursorRemoved(ofxTuioCursor & tcur){
	/*cout << " cursor removed: " + ofToString(tcur.getCursorID())+
	 " X: "+ofToString(tcur.getX())+
	 " Y: "+ofToString(tcur.getY())
	 << endl;*/
	
	mtActionsHub.touchUp(tcur.getX(), tcur.getY(), tcur.getFingerId(), NULL);
	mtSliderHub.touchUp(tcur.getX(), tcur.getY(), tcur.getFingerId(), NULL);
	
	//draggableRotatableScalableItem.touchUp(tcur.getX(), tcur.getY(), tcur.getCursorID(), NULL);

	//forward the touch events to ofxMultiTouch for the InteractiveObjects
	ofxMultiTouch.touchUp(tcur.getX(), tcur.getY(), tcur.getFingerId(), NULL);
}

void testApp::tuioCursorUpdated(ofxTuioCursor & tcur){
	...
	mtActionsHub.touchMoved(tcur.getX(), tcur.getY(), tcur.getFingerId(), &multiTouchCustomData);
	mtSliderHub.touchMoved(tcur.getX(), tcur.getY(), tcur.getFingerId(), &multiTouchCustomData);
	/*
	...
	*/
	//forward the touch events to ofxMultiTouch for the InteractiveObjects
	ofxMultiTouch.touchMoved(tcur.getX(), tcur.getY(), tcur.getFingerId(), NULL);
}
